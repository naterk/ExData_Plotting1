##
##  Plot 1: Create a histogram of Global Active Power for the dates 01/02/2007 and 02/02/2007
##
...
##
## Plot the graph on a PNG device sized 480x480 pixels.
##
...
hist(household.data$Global_active_power,main=p.main,xlab=p.xlab,ylab=p.ylab,col=p.col)
